...
export const info = {
  ...
  socials: [
    {
      link: 'https://drive.google.com/file/d/1lSSshd8zuK7yd-TjDZtfhHU3RoV4K4KS/view?usp=sharing', // this should be https://yourname.com/resume.pdf once you've deployed
