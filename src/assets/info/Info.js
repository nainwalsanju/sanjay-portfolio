...
export const info = {
  ...
  socials: [
    {
      link: 'https://drive.google.com/file/d/1AIhB9Z-9HLpNnJ-_KLyGn-co6o4wzw1E/view?usp=drive_link', // this should be https://yourname.com/resume.pdf once you've deployed
