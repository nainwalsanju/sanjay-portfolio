...
export const info = {
  ...
  socials: [
    {
      link: 'https://drive.google.com/file/d/1kmLTwMK7LWdmSZsAcPCFiHmQTFYC93p_/view?usp=sharing', // this should be https://yourname.com/resume.pdf once you've deployed
